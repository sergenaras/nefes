...
// const GITHUB_CDN = 'https://raw.githubusercontent.com/sergenaras/nefes/main/ikon/';

// İKON DOSYA YOLLARI
const iconFiles = {
    in: GITHUB_CDN + 'nefes_al.png',
    out: GITHUB_CDN + 'nefes_ver.png',
    hold: GITHUB_CDN + 'nefes_tut.png',
    squeeze: GITHUB_CDN + 'yumruk_sik.png',
    candle: GITHUB_CDN + 'mum_üfle.png'
};

// FALLBACK: İnline SVG İkonlar (PNG dosyası yüklenemezse kullanılır)
const icons = {
    ...
    candle: '<path d="M12 2c0 0-3 2.5-3 6 0 4 6 4 6 0 0-3.5-3-6-3-6z" fill="#e8c1e8"/><rect x="10" y="8" width="4" height="14" rx="1" fill="currentColor"/>'
};
